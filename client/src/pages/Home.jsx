...
const RenderCard = ({data, title}) => {
  ...
  return(
    <h2 className='mt-5 font-bold text-[#6449ff] text-xl-upperclass'>{title}</h2>
  )
}
    ...
    <section className='max-w-7xl mx-auto'>
      ...
      <div className='mt-10'>
        {loading ? (
          ...
          <>
            {searchText && (
              <h2 className='font-medium text-[#666e75] text-xl mb-3'>Showing reuslts for <span className='text-[#222328]'>{searchText}</span></h2>
            )}
